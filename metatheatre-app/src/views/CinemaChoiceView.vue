        ...
        <div v-else class="theater-selection-container">
            ...
            <div class="region-list">
                <ul>
                    ...
                    <li
                        v-for="(theatersArray, regionName) in regionData"
                        :key="regionName"
                        :class="{ active: selectedRegion === regionName }"
            ...
            <div class="theater-list">
                <ul>
                    <!-- 선택된 지역의 극장 배열을 순회 -->
                    <li
                        v-for="(theater, tIndex) in selectedRegionTheaters"
                        :key="theater.id"
                        :class="{ active: selectedTheaterIndex === tIndex }"
                        @click="selectTheater(tIndex)"
                    >
