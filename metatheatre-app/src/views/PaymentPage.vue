<template>
	<div class="mobile-container">
		...
		<PaymentButton :price="price" :method="selectedMethod" :movie="movie" :playing-id="playingId"
...
onMounted(() => {
	...
	youthCount.value = Number(route.params.youthCount) || 1;
	adultCount.value = Number(route.params.adultCount) || 1;
