    ...
    <div class="card" @click="handleCardClick">
        ...
        <div class="card-content">
            <div class="card-content-top">
                <img
                    :src="getGradeImage(movie.watchGrade)"
                    class="grade-icon"
                />
            ...
            <p class="info">
                ...
                <i class="bi bi-stopwatch"></i> {{ movie.showTime
                }}{{ t("etc.minute") }}
            </p>
            <p class="info">
                <i class="bi bi-camera-reels"></i> {{ movie.movieDirector }}
            </p>
            <p class="info">
                <i class="bi bi-globe"></i> {{ movie.movieNation }}
            </p>
            <p v-if="category === 'bo'" class="count">
                <i class="bi bi-people-fill"></i> {{ movie.totalAudience
                }}{{ t("etc.audience") }}
            </p>
            <p v-else-if="category === 'cs'" class="count">
                <i class="bi bi-heart-fill"></i> {{ movie.likeCount
                }}{{ t("etc.like") }}
            </p>
        </div>
    </div>
