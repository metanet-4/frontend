    ...
    <div class="card" @click="handleCardClick">
        ...
        <div class="card-content">
            ...
            <p class="info">
                ...
                {{ formatDate(movie.releaseDate) }} · <i class="bi bi-stopwatch"></i> {{ movie.showTime }}분
            </p>
            <p class="info"><i class="bi bi-camera-reels"></i> {{ movie.directors }}</p>
            <p class="info"><i class="bi bi-globe"></i> {{ movie.nation }}</p>
            <p v-if="category === 'bo'" class="count"><i class="bi bi-people-fill"></i> {{ movie.totalAudience }}명</p>
            <p v-else-if="category === 'cs'" class="count"><i class="bi bi-heart-fill"></i> {{ movie.likeCount }}개</p>
        </div>
    </div>
</template>
